...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#010202] text-white font-sans selection:bg-emerald-500/50 overflow-x-hidden">
      ...
      <FeatureSection number="01" icon={<Box className="text-emerald-500" />} title="Dustbin finder" problem="Most maps ignore dustbins. People litter because finding a bin is harder than finding a cafe." solution="We map every local bin. Our app guides you to the nearest one and tells you exactly how to separate your waste so it actually gets recycled." />
